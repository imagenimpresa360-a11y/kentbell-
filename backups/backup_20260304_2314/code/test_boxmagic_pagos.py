...
async def get_pagos_report():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print("Going direct to Reporte de Pagos...")
            await page.goto("https://boxmagic.cl/reportes/v2/reportes_pagos")
            await page.wait_for_load_state("networkidle")
            await asyncio.sleep(5)
            
            print("Screenshot of Pagos Report:")
            await page.screenshot(path="reports_pagos.png")
            
            print("Dumping HTML...")
            with open("reports_pagos.html", "w", encoding="utf-8") as f:
                f.write(await page.content())
                
        except Exception as e:
            print(f"Error: {e}")
            await page.screenshot(path="error_pagos.png")
        finally:
            await browser.close()

if __name__ == "__main__":
    asyncio.run(get_pagos_report())

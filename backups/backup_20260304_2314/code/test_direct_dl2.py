...
async def direct_dl_fix2():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Wait for any progress circular to hide
            print("Waiting for loaders to disappear...")
            try:
                await page.locator("md-progress-circular").wait_for(state="hidden", timeout=30000)
            except:
                pass
            
            await page.wait_for_load_state("networkidle")
            await asyncio.sleep(10) # extra wait
            
            print("Screenshot after direct nav:")
            await page.screenshot(path="lioren_direct2.png")
            ...
            if count > 0:
                ...
                # Check if it has a direct href or requires JS click
                ...
                print("No excel button found. Taking HTML dump.")
                with open("lioren_direct2_html.txt", "w", encoding="utf-8") as f:

...
async def consultar_documentos_pw():
    load_dotenv()
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            # Pick the visible one inside the sidebar
            ...
            await asyncio.sleep(5)
            print("URL:", page.url)
            await page.screenshot(path="lioren_consultar_pw.png")
            print("Screenshot taken.")
            
        except Exception as e:
            print(f"Error: {e}")
            await page.screenshot(path="lioren_pw_err.png")
        finally:
            await browser.close()

if __name__ == "__main__":
    asyncio.run(consultar_documentos_pw())
